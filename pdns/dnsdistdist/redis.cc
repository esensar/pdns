...
std::unique_ptr<RedisReplyInterface<std::vector<std::pair<int, boost::optional<std::string>>>>> RedisHMGetCommand::operator()(const RedisClient& client, const std::string& hash_key, const std::vector<std::pair<int, std::string>>& fields) const
{
