...
class BloomFilter : public GenericCacheInterface<std::string, LuaAny>
{
public:
  ...
  void insert(const std::string& key, [[maybe_unused]] LuaAny value) override
  {
    insertKey(key);
  }
  ...
  bool getValue(const std::string& key, [[maybe_unused]] LuaAny& value) override
  {
    return contains(key);
  }
  ...
  [[nodiscard]] virtual const GenericCacheInterface<std::string, LuaAny>::Stats& getStats() const override
  {
    return d_stats;
  }
...
private:
  ...
  GenericCacheInterface<std::string, LuaAny>::Stats d_stats{"filter=\"bloom\""};
};

class CuckooFilter : public GenericCacheInterface<std::string, LuaAny>
{
public:
...
private:
  ...
  using stats_t = GenericCacheInterface<std::string, LuaAny>::Stats;
  ...
  std::mt19937 d_gen;
  time_t d_lastScan;
  GenericCacheInterface<std::string, LuaAny>::Stats d_stats{"filter=\"cuckoo\""};
};
